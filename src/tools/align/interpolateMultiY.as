...
{
	/*
	 * interpolate multiple DisplayObjects at multiple weights at t == (0 <= t <= 1).  at tx=1, the position of the object would be aligned to the right-most bounds, and ty=0 would position to the left
	 *
